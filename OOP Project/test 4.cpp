    ...
    void editEmployee() {
        ...
        while (getline(inFile, line)) {
            ...
            if (fileEmail == email) {
                ...
                cout << "Editing Employee: " << firstName << " " << lastName << endl;

                cout << "Edit First Name (current: " << firstName << "): ";
                cin >> firstName;
                cout << "Edit Last Name (current: " << lastName << "): ";
                cin >> lastName;
                cout << "Edit Department (current: " << department << "): ";
                cin >> department;
                cout << "Edit Contact (current: " << contact << "): ";
                cin >> contact;
                cout << "Edit Salary (current: " << salary << "): ";
                cin >> salary;
                cout << "Edit Contract Period (current: " << contractPeriod << "): ";
                cin >> contractPeriod;

                tempFile << fileEmail << " " << password << " " << empID << " " << firstName << " " << lastName << " "
                         << department << " " << contact << " " << salary << " " << contractPeriod << endl;
            } else {
                tempFile << line << endl;
            }
        }
